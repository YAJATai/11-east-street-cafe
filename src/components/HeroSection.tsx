...
const SLIDES_TEXT = [
  {
    subtitle: "London Themed Bar & Grill • Camp, Pune • 4.0★ (4,073 reviews)",
    title: "11 East Street",
    caption: "Double decker bus, red phone box & colonial vibes — London in the heart of Pune"
  },
  {
    subtitle: "Pizza • Pasta • Chicken Satay • Gourmet Burgers",
    title: "Global Flavours",
    caption: "From tandoori chicken to burrito bowls — global plates served with British swagger"
  },
  {
    subtitle: "Mocktails • Nachos • Cheese Fondue • Butter Chicken",
    title: "Eat. Drink. Repeat.",
    caption: "Crispy fries, loaded nachos, creamy fondue & the best vibes in Camp"
  }
];
              ...
              <div className={`layer-content-${index} absolute inset-0 flex flex-col items-center justify-between select-none pb-24 pt-[18vh] md:pt-[22vh]`}>
                ...
                <div className="w-full px-4 text-center">
                  <h1 className="font-accent text-[12vw] md:text-[6.5vw] text-white font-normal tracking-wide drop-shadow-[0_4px_20px_rgba(0,0,0,0.85)] select-all leading-tight">
                    {index === 0 ? (
                      <>
                        11 <span className="italic text-gold">East Street</span>
                      </>
                    ) : index === 1 ? (
                      <>
                        Global <span className="italic text-gold">Flavours</span>
                      </>
                    ) : (
                      <>
                        Eat. Drink. <span className="italic text-gold">Repeat.</span>
                      </>
                    )}
                  </h1>
