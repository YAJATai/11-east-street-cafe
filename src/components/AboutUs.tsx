...
const ABOUT_TEXT = "11 East Street Cafe brings the spirit of London to the heart of Camp, Pune. Step inside and find a iconic red double decker bus, a classic British phone box, and a colonial-inspired interior that transports you across continents. Our menu is as global as our vibe — wood-fired pizzas, smoky chicken satay, gourmet burgers, hearty burrito bowls, cheesy nachos, and creamy fondue. Whether you're here for a quick bite, a long catch-up with friends, or a celebration under the warm glow of our colonial chandeliers — 11 East Street is where the world meets Pune.";

const HIGHLIGHTS = [
  'Gourmet Chicken Burger', 'Veggies Oomph Pizza', 'Chicken Satay', 'Burrito Bowl',
  'Loaded Nachos', 'Cheese Fondue', 'Butter Chicken', 'Pasta',
  'Mocktails', 'Garlic Bread', 'Mojito', 'Tandoori Chicken'
];
